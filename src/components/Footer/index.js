      ...
      <div className='container'>
        <div className='columns has-text-centered'>
          ...
          <Link
            ...
            to='/kontakt'>
            Kontakt </Link>
          <div className='column navbar-item'><a id='BipLink' href='http://przedszkole371.bip.um.warszawa.pl/default.htm' target='_blank' rel='noopener' aria-label='Łącze do Biuletynu Informacji Publicznej'><div role='button' className='bip-logo' alt='Logo Biuletynu Informacji Publicznej' aria-labelledby='BipLink'/></a></div>
        </div>
        <hr />
